...
def dispatch(args, extra_args=None):
    ...
    if skip_cgra_map:
        ...
        # Apps whose coreir is fully generated by strait templates can skip
        # clockwork_codegen and metamapper (the hack script produces design_top.json directly).
        STRAIT_COREIR_APPS = {"rope_fp"}
        ...
        elif app_name in STRAIT_COREIR_APPS:
