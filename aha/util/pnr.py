...
def add_subparser(subparser):
    ...
    parser.add_argument("--mu-test", default="", type=str, help="Specifies the test to run on the external voyager matrix unit. This collateral for running this test will be generated by the voyager compiler. If not specified, the test will not be run.")
    parser.add_argument("--skip-cgra-pnr", action="store_true", help="Skips CGRA place and route, assuming collateral has already been generated")
...
def dispatch(args, extra_args=None):
    ...
    skip_cgra_pnr = args.skip_cgra_pnr
    if skip_cgra_pnr:
        print(f"\033[93mINFO: Skipping CGRA place and route for {args.app} as per settings in regress.py. Assuming PNR collateral has previously been generated...\033[0m")
    else:
        print(f"\033[92m--- Running PNR for {args.app}...\033[0m")
        if args.log:
