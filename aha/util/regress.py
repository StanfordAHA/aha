...
def test_dense_app(
        test, width, height, env_parameters, extra_args, layer=None, dense_only=False,
        use_fp=False, using_matrix_unit=False, mu_datawidth=16,
        num_fabric_cols_removed=0, mu_oc_0=32, dense_ready_valid=False,
        E64_mode_on=False, E64_multi_bank_mode_on=False, behavioral_MU=False, mu_test=""):
    ...
    # These tests skip CGRA mapping to save time.
    # The assumption is that the collateral was generated by a
    # prior test. This means certain tests must be run in order.

    skip_cgra_map = test in [
    ...
    # These tests skip CGRA place and route to save time.
    # The assumption is that the collateral was generated by a
    # prior test. This means certain tests must be run in order.

    skip_cgra_pnr = test in [
        "resnet18-conv2d_mx_default_16 -> zircon_nop_post_conv5_x_kernel1_RV_E64_MB",
        "resnet18-submodule_16 -> zircon_residual_relu_fp_post_conv5_x_kernel1_RV_E64_MB",
        "resnet18-submodule_16 -> zircon_residual_relu_fp_post_conv5_x_kernel2_RV_E64_MB",
        "resnet18-submodule_16 -> zircon_residual_relu_fp_post_conv5_x_kernel3_RV_E64_MB",
