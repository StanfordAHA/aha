...
RUN ./contrib/setup-bison.sh && ./contrib/setup-flex.sh && ./contrib/setup-smt-switch.sh --python && ./contrib/setup-btor2tools.sh && pip uninstall smt_switch -y && pip install -e ./deps/smt-switch/build/python
