...
WORKDIR /aha
RUN source bin/activate && pip install setuptools==60.8.2 && pip install wheel six && pip install systemrdl-compiler peakrdl-html && pip install -e . && pip list && python --version && pip --version && aha deps install
