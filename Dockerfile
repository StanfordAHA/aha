...
RUN source scl_source enable llvm-toolset-7.0 && source /aha/bin/activate && export CXXFLAGS=-Wno-maybe-uninitialized && export COREIR_DIR=/aha/coreir-apps && make && make distrib
